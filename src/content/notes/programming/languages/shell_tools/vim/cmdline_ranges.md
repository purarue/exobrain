...
I have a script called `ix` [here](https://github.com/purarue/pura-utils/blob/main/shellscripts/ix) which accepts some text as STDIN and makes an `ix` (pastebin), so I can do something like:
