...
copy_personal_notes:
	rsync -Pah --checksum "$(LOCAL_NOTES_DIR)/" ./src/content/notes/personal
...
sync_personal_notes_to_server:
	rsync -Pah --checksum ./src/content/notes/personal/ vultr:~/code/exobrain/src/content/notes/personal
